...
This tool aims to cater to diverse applications, ranging from microscopy images to medical imaging such as CT, MRI scans and vtk models.
...
vtk-file:
```
no specific format required. Check data/vtk/wirbel.vtk for an example.
...
Go to the Path where the Application is stored (root) and type: "java -jar .\amrs-1.0-SNAPSHOT-jar-with-dependencies.jar"
